...
const { getProducts, getProduct, createProduct, updateProduct, deleteProduct, uploadProductImages, deleteProductImage, setProductImagePrimary, getRelatedProducts } = require('../controllers/productController');
...
router.patch('/:id/images/:imageId/primary', protect, authorize('admin'), setProductImagePrimary);
